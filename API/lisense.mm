...
- (NSString *)getPackageVersion { return [[PackageValidator shared] getPackageVersion]; }
- (NSString *)getAppID { return [[PackageValidator shared] getAppID]; }
- (NSString *)getAppDisplayName { return [[PackageValidator shared] getAppDisplayName]; }
